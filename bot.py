...
def start_note(update: Update, context: ContextTypes.DEFAULT_TYPE):
    context.bot.send_message(chat_id=update.effective_chat.id, text="Hello! Please input the movie name:")
    return MOVIE_NAME


def receive_name(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
def receive_genre(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
def receive_note(update: Update, context: ContextTypes.DEFAULT_TYPE):
